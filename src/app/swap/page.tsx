      ...
      <div className="flex justify-between items-center w-full">
        <div className="flex justify-center items-center">
          ...
          <div className="flex justify-center items-center space-x-2 p-3">
            ...
            <Image src="/dropdown.svg" width={8.41} height={5.36} alt="icon" />
          </div>
        </div>
...
export default function SwapPage() {
  ...
  const { lendingContract, swapContract, PoolTrackerContract } =
  ...
  useEffect(() => {
    (async () => {
      ...
      try {
        const data = await PoolTrackerContract.call("exists", [
          "0x1A8904d9dE95C0aAfe81250E106364Bf21fEECaB",
          "0xD2DfbdA8F99b59B88Ff6926FDdc45244D877bB69",
        ]);
      ...
      // console.log("Lending contract", lendingContract)
      // const data = await lendingContract.call(
      //   "usdConverter",
      //   ["0x1A8904d9dE95C0aAfe81250E106364Bf21fEECaB"],
      //   {
      //     from: walletAddress,
